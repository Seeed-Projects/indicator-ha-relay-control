...
lv_obj_t * ui_switch2;
lv_obj_t * ui_switch2_logo2;
lv_obj_t * ui_switch2_label2;
...
lv_obj_t * ui_sensor_data_energy_1;
...
void ui_event_switch2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_VALUE_CHANGED &&  lv_obj_has_state(target, LV_STATE_CHECKED)) {
        _ui_image_set_property(ui_switch2_logo2, _UI_IMAGE_PROPERTY_IMAGE, & ui_img_ic_switch2_on_png);
        switch_event_cb(e);
    }
    if(event_code == LV_EVENT_VALUE_CHANGED &&  !lv_obj_has_state(target, LV_STATE_CHECKED)) {
        _ui_image_set_property(ui_switch2_logo2, _UI_IMAGE_PROPERTY_IMAGE, & ui_img_ic_switch2_off_png);
        switch_event_cb(e);
    }
}
